...
if sys.version_info[0] != 3:
    mesgdcrt.FailureMessage("MLBOMB will work only in Python v3")
    sys.exit()
...
description = """MLBOMB - Your Friendly Spammer Application

MLBOMB can be used for many purposes which incudes -
